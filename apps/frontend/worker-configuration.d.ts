/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dc02a522cd1da1fa981f47705be30b87)
// Runtime types generated with workerd@1.20260616.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	VECTORIZE: VectorizeIndex;
	AI: Ai;
	BETTER_AUTH_URL: "https://recruiting.darkalphacapital.com";
	OPENAI_API_KEY: "";
	NEXTCLOUD_URL: "";
	NEXTCLOUD_USER: "";
	NEXTCLOUD_PASSWORD: "";
	DOCUMENT_INDEXING_WORKFLOW: Workflow<Parameters<import("./src/server").DocumentIndexingWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "OPENAI_API_KEY" | "NEXTCLOUD_URL" | "NEXTCLOUD_USER" | "NEXTCLOUD_PASSWORD">> {}
}
