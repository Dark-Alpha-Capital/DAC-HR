...
import { updateCandidateDocument } from "@/lib/actions/update-candidate-document";
    ...
    onSubmit: async ({ value }) => {
      ...
      startTransition(async () => {
        try {
          ...
          // Update the candidate document with the final URL
            ...
            <form.Field
              ...
              children={(field) => {
                ...
                return (
                  <>
                    <Field>
                      <FieldLabel htmlFor="file-upload">Upload New File</FieldLabel>
                      <Input
                        id="file-upload"
                        type="file"
                      ...
                      />
                      <FieldDescription>
                        All file types accepted except videos (max 500MB). Leave
