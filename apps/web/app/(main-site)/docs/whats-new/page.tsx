...
export const metadata: Metadata = {
  title: "What's New - Documentation - DAC HR",
  description:
    "Reference guide for recent platform changes in DAC HR, including feature behavior and implementation updates.",
};

export default function WhatsNewDocsPage() {
  return (
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              Sensitive logs were reduced and email data is now redacted in
              key auth/candidate routes.
            </li>
          </ul>
          <p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              Onboarding and interview feedback flows were updated to use
              upsert patterns for better concurrency behavior.
            </li>
            <li>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              Turbo now runs a dedicated test task in CI/local workflows.
            </li>
            <li>
